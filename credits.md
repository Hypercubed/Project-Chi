...
## project-chi-next relies on the work of 370 people:
...
- **John-David Dalton** *john.david.dalton@gmail.com* (40 packages)
...
- **TJ Holowaychuk** *tj@vision-media.ca* (12 packages)
...
- **Douglas Wilson** *doug@somethingdoug.com* (5 packages)
...
- **Shinnosuke Watanabe** *snnskwtnb@gmail.com* (3 packages)
...
- **Meryn Stol** *merynstol@gmail.com* (1 package)
- **Jordan Harband** *ljharb@gmail.com* (1 package)
...
- **Forbes Lindesay** *forbes@lindesay.co.uk* (1 package)
