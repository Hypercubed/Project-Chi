# Credits for Project-χ

## JSPM

- **John-David Dalton** *john.david.dalton@gmail.com* (18 packages)
...
- **Isaac Z. Schlueter** *isaacs@npmjs.com* (3 packages)
...
- **Joshua Boy Nicolai Appelman** *joshua@jbna.nl* (1 package)

## npm

- **Sindre Sorhus** *sindresorhus@gmail.com* (132 packages)
- **Blaine Bublitz** *blaine@iceddev.com* (63 packages)
- **John-David Dalton** *john.david.dalton@gmail.com* (55 packages)
- **Mathias Bynens** *mathias@qiwi.be* (54 packages)
- **hzoo** *hi@henryzoo.com* (47 packages)
- **amasad** *amjad.masad@gmail.com* (46 packages)
- **Sebastian McKenzie** *sebmck@gmail.com* (46 packages)
- **loganfsmyth** *loganfsmyth@gmail.com* (45 packages)
- **Jesse McCarthy** *npm-public@jessemccarthy.net* (45 packages)
- **Jon Schlinkert** *github@sellside.com* (44 packages)
- **thejameskyle** *me@thejameskyle.com* (44 packages)
...
- **Jonathan Ong** *jonathanrichardong@gmail.com* (17 packages)
...
- **Nathan Rajlich** *nathan@tootallnate.net* (8 packages)
...
- **Charlie Robbins** *charlie.robbins@gmail.com* (7 packages)
...
- **jamestalmage** *james@talmage.io* (4 packages)
- **Andres Suarez** *zertosh@gmail.com* (3 packages)
- **IndigoUnited** *hello@indigounited.com* (3 packages)
...
- **Ben Newman** *bn@cs.stanford.edu* (2 packages)
...
- **danvk** *danvdk@gmail.com* (1 package)
