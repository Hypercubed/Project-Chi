...
- **Mike Bostock** *mike@ocks.org* (29 packages)
- **John-David Dalton** *john.david.dalton@gmail.com* (19 packages)
...
- **Angular Core Team** *angular-core+npm@google.com* (7 packages)
- **Jake Verbaten** *raynos2@gmail.com* (7 packages)
- **Curran Kelleher** (7 packages)
...
- **J. Harshbarger** (4 packages)
- **Mark Cavage** *mcavage@gmail.com* (3 packages)
- **Fedor Indutny** *fedor@indutny.com* (3 packages)
...
- **jQuery Foundation and other contributors** (2 packages)
